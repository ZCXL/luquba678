 ...
 * 
 */
public class ImgScrollViewPager extends ViewPager {
	...
	public ImgScrollViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
		...
		timer.schedule(new TimerTask() {
			public void run() {
				mActivity.runOnUiThread(new Runnable() {
					public void run() {
						ImgScrollViewPager.this
								.setCurrentItem(ImgScrollViewPager.this
										.getCurrentItem() + 1);
					}
				});
			}
