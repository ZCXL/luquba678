...
public class Slider extends CustomView {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = LayoutUtils.getRelativeTop(this) - getHeight() / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (value == min) {
            ...
            paint.setStrokeWidth(LayoutUtils.dpToPx(2, getResources()));
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Set size of view
        setMinimumHeight(LayoutUtils.dpToPx(48, getResources()));
        setMinimumWidth(LayoutUtils.dpToPx(80, getResources()));
        ...
        RelativeLayout.LayoutParams params = new LayoutParams(LayoutUtils.dpToPx(20,
                getResources()), LayoutUtils.dpToPx(20, getResources()));
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= LayoutUtils.dpToPx(6, getResources());
                size += LayoutUtils.dpToPx(2, getResources());
            }
            canvas.drawCircle(
                    ViewHelper.getX(ball)
                            + LayoutUtils.getRelativeLeft((View) ball.getParent())
            ...
            if (animate == false) {
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        + LayoutUtils.getRelativeLeft((View) ball
